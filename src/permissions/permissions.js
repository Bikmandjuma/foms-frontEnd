...
export const ACTIONS = {
  ...
  FIELD_TEAM_REPORTS_VIEW_UNCONFIRMED: "field-team-reports:view-unconfirmed",
  EXPENSES_VIEW: "expenses:view",
  EXPENSES_EDIT: "expenses:edit",
  EXPENSES_DELETE: "expenses:delete",
  OUTCOMES_VIEW: "outcomes:view",
  OUTCOMES_CONFIRM: "outcomes:confirm",
  MEAL_TRANSPORT_REPORTS_MANAGE: "meal-transport-reports:manage",
  MEAL_TRANSPORT_REPORTS_CREATE: "meal-transport-reports:create",
  MEAL_TRANSPORT_REPORTS_APPROVE: "meal-transport-reports:approve",
